...
Generated 2026-08-29. Every field below was blank in the automated sources. Fill any of them in `manual_data.json` and rerun `python build_summary.py`; your values take priority and are never overwritten.
...
## Studies with no numeric performance figure (73 of 76)
...
- Studies with no identifiable model name: **58**
- Studies with no identifiable calculation method: **20**
- Studies with no numeric metric: **73**
